    ...
    setDoc(doc(db, 'diseases', 'disease_list'), {
        list: [
...

            {
                ...
                description: "Дизентерія – бактеріальна інфекція, яка передається від хворої людини до здорової. Наслідки від інфекції доволі неприємні. Дизентерія – це синдром гострого ураження людини із запаленням дистального відділу товстої кишки з типовими проявами коліту з та появою крові у випорожненнях. Збудником дизентерії є бактерія Shigella dysenteriae. При руйнуванні мікробів виділяється токсин, який відіграє велику роль у розвитку хвороби й обумовлює її прояви. Збудники дизентерії відрізняються високою стійкістю у зовнішньому середовищі. Залежно від температурно-вологісних умов вони зберігаються від 3-4 діб до 1-2 місяців, а в ряді випадків до 3-4 місяців і навіть більше. "
            },
